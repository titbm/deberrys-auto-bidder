...
- При успехе - увеличить ставку и сразу продолжить
...
- Проверяет баланс и текущую ставку каждые 500мс
...
### Результаты тестирования (24.12.2024):
1. ✅ Селекторы проверены на реальной странице
2. ✅ Баланс читается корректно
3. ✅ Текущая ставка читается корректно
...
- Работает только на deberrys.xyz/auctions/*
...
- v1.6 - Увеличено время ожидания результата до 60 секунд, улучшена детекция ошибок
